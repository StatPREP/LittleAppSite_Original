...
You'll use the  [Little_App_Spread](`r Spread_app$url`) for this lesson. (See footnote^[<`r Spread_app$url`>]). Open the  little app. Make sure you click on Data in the top row. Set the Source package to Little Apps, the Data set to `NHANES2`.
...
1. Go to the ***Show codebook*** icon in the app, (the icon is between the i icon and the book mark icon). The documentation will appear. 
