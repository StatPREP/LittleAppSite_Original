...
6. [Regression Modeling](`r app_url("F")`)
...
[Stratification](`r app_url("T")`) | <img src="images/stratification.png" height="200px"> | [Regression](`r app_url("F")`) | <img src="images/regression-example-3.png" height="200px"> 
